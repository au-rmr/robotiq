...
class GripperActionServer(object):
    ...
    def __init__(self, name):
        ...
        self.status_listener = rospy.Subscriber("/gripper_control/status", Robotiq2FGripper_robot_input, queue_size=5, callback=self.update_status)
    ...
    def execute_cb(self, goal: GripperCommandGoal):
        ...
        rospy.loginfo('%s: Moving gripper to %f with effort %f' % (self._action_name, goal.command.position, goal.command.max_effort))
